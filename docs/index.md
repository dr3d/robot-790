...
Eric Robot 790 is a local-first embodied AI and robot experiment: a small robot
face and voice wrapped around a language model, tools, notes, idle thinking,
sparse continuity, firmware, memory experiments, and a lot of careful watching.
...
Robot 790 is the platform and series. Eric is the personage.

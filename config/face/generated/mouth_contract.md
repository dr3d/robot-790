...
| `tongue` | `Tongue` | silly | `mouth` | open=0.78, width=0.94, curve=0.84, skew=0.05, teeth=0.04, tension=0.04, slant=0.02, upperLift=0 |
| `frown` | `Frown` | sad | `mouth` | open=0.08, width=0.62, curve=-1.45, skew=-0.04, teeth=0, tension=0.44, slant=-0.08, upperLift=0 |
| `grimace` | `Grimace` | teeth, tense | `mouth` | open=0.18, width=0.88, curve=0.98, skew=0, teeth=0.42, tension=0.06, slant=0, upperLift=0 |
